...
public class Basketball {
    private static final String filePath = "file:///Users/Ryan/Downloads/owl2-swrl-tutorial-master/src/main/java/basketball.owl"; 
    ...
    public static void main(String[] args) throws OWLOntologyCreationException {
        ...
        OWLClass gameClass = factory.getOWLClass(":Game", pm);

        for (OWLNamedIndividual game : reasoner.getInstances(gameClass, false).getFlattened()) {
        		String gameRendered = renderer.render(game).split("#")[1];
            System.out.println("game id : " + gameRendered);
            
            OWLObjectProperty hasHomeTeamProperty = factory.getOWLObjectProperty(":hasHomeTeam", pm);
            for (OWLNamedIndividual homeTeam : reasoner.getObjectPropertyValues(game, hasHomeTeamProperty).getFlattened()) {
            ...
            for (OWLNamedIndividual awayTeam : reasoner.getObjectPropertyValues(game, hasAwayTeamProperty).getFlattened()) {
